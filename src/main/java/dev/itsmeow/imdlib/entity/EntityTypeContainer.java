...
public class EntityTypeContainer<T extends MobEntity> {
    ...
    protected Supplier<Set<Biome>> spawnBiomesSupplier;
    protected Set<Biome> spawnBiomesCache = null;
    ...
    protected void setSpawnBiomesSupplier(Supplier<Set<Biome>> biomesSupplier) {
    ...
    protected static List<String> setBiomesToIDs(Set<Biome> set) {
        return set.parallelStream().filter(Objects::nonNull).map(b -> b.getRegistryName().toString()).collect(Collectors.toList());
    }
    ...
    public static class Builder<T extends MobEntity> extends AbstractEntityBuilder<T, EntityTypeContainer<T>, Builder<T>> {
        ...
        private Builder(Class<T> EntityClass, EntityType.IFactory<T> factory, String entityNameIn, String modid) {
        ...
        public static <T extends MobEntity> Builder<T> create(Class<T> EntityClass, EntityType.IFactory<T> factory, String entityNameIn, String modid) {
    ...
    public class EntityConfiguration {
        ...
        protected void load() {
            if (hasSpawns()) {
                ...
                Function<ForgeConfigSpec.ConfigValue<List<? extends String>>, Set<Biome>> biomesLoader = (configList) -> {
                    HashSet<Biome> biomeKeys = new HashSet<>();
