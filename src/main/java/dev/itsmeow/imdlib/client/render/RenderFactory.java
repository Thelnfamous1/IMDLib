...
public class RenderFactory {
    ...
    public <T extends MobEntity, M extends EntityModel<T>> void addRender(Class<T> clazz, float shadowSize, Function<ImplRenderer.Builder<T, M>, ImplRenderer.Builder<T, M>> render) {
        RenderingRegistry.registerEntityRenderingHandler(clazz, render.apply(this.<T, M>r(shadowSize)).done());
    }

    public static <T extends Entity> void addRender(Class<T> clazz, IRenderFactory<T> renderer) {
